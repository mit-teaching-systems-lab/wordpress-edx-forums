...
<a href="#new-topic-<?php bbp_topic_id(); ?>" class="btn btn-info pull-left"><span class="glyphicon ipt-icon-ticket"></span> <?php _e( 'New Topic', 'ipt_kb' ); ?></a><?php bbp_forum_subscription_link(); ?>
<?php endif; ?>
