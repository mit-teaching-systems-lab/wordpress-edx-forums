			...
			<?php do_action( 'bbp_template_notices' ); ?>
				...
				<div>
					...
					<?php if ( bbp_allow_revisions() && bbp_is_topic_edit() ) : ?>
					 <?php if((MY_USER_EDIT_LOG_OPTION)||(user_can($user,'administrator'))||(array_key_exists('administrator',$my_uroles))||(lti_site_admin())||(array_key_exists('bbp_moderator',$my_uroles))||(array_key_exists('bbp_keymaster',
$my_uroles))||(array_key_exists('bbp_blocked',$my_uroles))) : ?>
					 ...
					 <?php else : ?>
						<input name="bbp_log_topic_edit" id="bbp_log_topic_edit" type="hidden" value="1"/>
					 <?php endif; ?>
					<?php endif; ?>					
