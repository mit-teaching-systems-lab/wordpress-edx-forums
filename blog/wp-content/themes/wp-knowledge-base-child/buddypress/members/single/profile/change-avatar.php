...
<?php else : ?>
	...
	<p><?php _e( 'Your avatar will be used on your profile and throughout the site. To change your avatar, please create an account with <a href="http://gravatar.com">Gravatar</a> using the same email address as you used to register on <a href="https://courses.edx.org/dashboard">edX</a>.', 'buddypress' ); ?></p>
