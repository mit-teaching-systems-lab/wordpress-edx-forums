 ...
 */
  public function __construct($key = NULL, $data_connector = '', $autoEnable = FALSE) {
    ...
    // error_log('$this->data_connector: ' . print_r($this->data_connector, true));
 ...
 */
  static function getDataConnector($data_connector, $db = NULL, $type = NULL) {
    ...
    // KR: modified this to hard code it to MySQLi, since on
    // PHP5 this was using the older mysql_connect but in PHP7
    // that isn't supported.  Passing in the options to use the
    // MySQLi type didn't work as expected, so this just
    // hard codes it to MySQLi
    $prefix  = 'wp_';
    $type = 'mysqli';
