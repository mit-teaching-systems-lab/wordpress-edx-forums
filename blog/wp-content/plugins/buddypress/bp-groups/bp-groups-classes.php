...
class BP_Group_Extension {
	...
	*/
        public function maybe_create_screen_save_notab() {
               ...
               // KR: guard for the method, since it's only defined on one subclass,
               // `BP_Forums_Group_Extension`.
               //
               // KR: This hook is a critical part of how forums are created for new groups.
               // I think we could move registering the hook into the
               // `BBP_Forums_Group_Extension` subclass, but don't yet fully understand all
               // the pieces here so am just guarding.
               if (is_callable(array($this, 'create_screen_save_notab'))) {
	               // There's no need to check the nonce since we removed the forum tab
